...
export default function App() {
  ...
  return (
    <div className={`flex flex-col h-screen overflow-hidden bg-bg-app text-text-primary transition-colors duration-200 ${isDark ? "dark" : ""}`}>
      ...
      <header className="bg-bg-card border-b border-border-subtle px-6 py-3.5 flex flex-col md:flex-row items-center justify-between gap-4 shrink-0 z-20 shadow-sm">
        <div className="flex items-center gap-3">
          <div className="w-9.5 h-9.5 bg-indigo-600 rounded-xl flex items-center justify-center shadow-lg shadow-indigo-500/20">
            <div className="w-4.5 h-4.5 border-3 border-white rounded-full"></div>
          </div>
          <div>
            <h1 className="text-base font-black text-text-primary tracking-tight leading-none flex items-center gap-1">
              COMMUNITY HERO <span className="text-indigo-600 italic font-bold">AI</span>
            </h1>
            <span className="text-[10px] text-text-secondary font-bold font-mono tracking-wider uppercase mt-1 block">Smart City Resolution Grid</span>
          </div>
        </div>

        {/* Center: Live App Indicator with Sparkles Badge */}
        ...
        <div className="flex items-center gap-2.5">
          ...
          <a
            ...
            className="flex items-center gap-2 p-2 rounded-xl bg-bg-panel border border-border-subtle text-text-secondary hover:text-text-primary hover:bg-bg-app transition-all duration-200 shadow-sm"
          ...
          <button
            ...
            className="flex items-center gap-2 p-2 rounded-xl bg-bg-panel border border-border-subtle text-text-primary hover:bg-bg-app transition-all duration-200 shadow-sm cursor-pointer"
          ...
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-indigo-600 text-white hover:bg-indigo-500 transition-all duration-200 shadow-md shadow-indigo-600/15 font-bold text-xs shrink-0 cursor-pointer"
            id="btn-docs-trigger"
          >
